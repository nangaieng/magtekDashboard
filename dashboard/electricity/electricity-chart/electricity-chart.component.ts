...
export class ElectricityChartComponent implements AfterViewInit, OnDestroy {
  ...
  constructor(private theme: NbThemeService) {
    ...
    const points = [490000, 490000, 495000, 500000, 505000, 510000, 520000, 530000, 550000, 580000, 630000,
      720000, 800000, 840000, 860000, 870000, 870000, 860000, 840000, 800000, 720000, 200000, 145000, 130000, 130000,
      145000, 200000, 570000, 635000, 660000, 670000, 670000, 660000, 630000, 580000, 460000, 380000, 350000, 340000,
